...
curl -o /tmp/tcpa_packets_180619_1151.tar.gz http://down.caibao.in/Git/TCPA/tcpa_packets_180619_1151.tar.gz
...
rpm -ivh http://down.caibao.in/Git/TCPA/kernel-3.10.0-693.5.2.tcpa06.tl2.x86_64.rpm --force
